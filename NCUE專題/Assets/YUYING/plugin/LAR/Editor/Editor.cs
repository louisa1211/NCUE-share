...
*/
    ...
    {
        Object prefab = AssetDatabase.LoadAssetAtPath("Assets/plugin/LAR/Prefabs/LARCamera.prefab", typeof(GameObject));
    ...
    {
        Object prefab = AssetDatabase.LoadAssetAtPath("Assets/plugin/LAR/Prefabs/LarTarget.prefab", typeof(GameObject));
        GameObject clone = Instantiate(prefab, Vector3.zero, Quaternion.identity) as GameObject;
    ...
    {
        Object prefab = AssetDatabase.LoadAssetAtPath("Assets/plugin/LAR/Prefabs/LarWorldSpaceLabel.prefab", typeof(GameObject));
        GameObject clone = Instantiate(prefab, Vector3.zero, Quaternion.identity) as GameObject;
